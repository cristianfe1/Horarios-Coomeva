...
$sql = "SELECT id, title, start, end, color, resp, anota FROM soporte ";
...
<head>
    ...
    <title>Horario Soporte Aplicativo (EBS)</title>
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/Horarios/descarga/Horario_AP.xlsx" download="Horario_AP">Descargar Excel</a>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Horario Soporte Aplicativo (EBS)</h1>
		...
		<tr bgcolor="#31bc86">
		    ...
		    <td align="center"><font color="#FFFFFF"><strong>Horas</strong></font></td>
		</tr>
		<tr bgcolor="#0071c5">
		    <td><font color="#FFFFFF">Horario Oficina</font></td>
		    <td align="center"><font color="#FFFFFF">07:30 a 12:20 - 14:00 a 18:00</font></td>
		</tr>
		<tr bgcolor="#FF0000">
		    <td><font color="#FFFFFF">Teletrabajo Turno de la Mañana</font></td>
		    <td align="center"><font color="#FFFFFF">07:30 a 14:00</font></td>
		</tr>
		<tr bgcolor="#008000">
		    <td><font color="#FFFFFF">Teletrabajo Turno de la Tarde</font></td>
		    <td align="center"><font color="#FFFFFF">14:00 a 22:00</font></td>
		</tr>
		<tr bgcolor="#FFD700">
		    <td><font color="#FFFFFF">Teletrabajo Fin de Semana</font></td>
		    <td align="center"><font color="#FFFFFF">09:00 a 19:00</font></td>
		</tr>
		</table>
		<br>
		...
		<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="addEvent0.php">
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			<form class="form-horizontal" method="POST" action="editEventTitle0.php">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
